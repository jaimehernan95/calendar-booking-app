...
(0, _i18NextDefault.default).init({
    ...
    resources: {
        ...
        fr: {
            translation: (0, _frJsonDefault.default)
        }
    }
}).then(()=>{
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (timeSlotsContainer) (0, _app.setupCalendar)(); // Initialize the calendar
